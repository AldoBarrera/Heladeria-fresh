...
import LogiLoginComponent from "./login/logi-login.component" 
...
import * as LogiLoginRoute from "./login/routes/logi-login.route" 
...
class ResRestaurantModule extends App.CommonModule {
    ...
    public async addRoutes(appExpress:express.Application, io?: any) {
      ...
      var logiLoginRoute = new LogiLoginRoute.LogiLoginRoute('login', io); 
      appExpress.use('/api/v1/restaurant', logiLoginRoute.router); 
...
export {DishDishesComponent, OrdnOrderComponent, OrddOrderDetailsComponent, InveInventoryComponent,  ResRestaurantModule, LogiLoginComponent} ;
